...
const App: Component = () => {
  ...
  return (
      <div>
        ...
        <ul>
            <li><A href="/">Home</A></li>
            <li><A href={`/login?returnTo=${encodeURIComponent(loginLinkShouldReturnTo())}`}>Login</A></li>
            <li><a href="#" onClick={(e) => {e.preventDefault(); setAuth(fauxLogin());}}>Faux Login</a></li>
            <li><a href="#" onClick={(e) => {e.preventDefault(); logout();}}>Logout</a> (TODO: invalidate token with API call)</li>
        </ul>
          returnTo: {JSON.stringify(returnTo())}<br/>
          auth-auth: {JSON.stringify(auth())}<br/>
          auth-loading: {String(loading())}<br/>
...
function fauxLogin(): UserAuthorization {
    ...
    return {
        "access_token": "951c8ccd3973ee903b6c3c42a63dbe3c3878c0d6dffdc75b12453019791efc134b6776de5f64221f33bd7ef01c3e43301c3c3c10a056b0f66c8cdf37741ffaf6",
        "valid_until": expiry,
        "user_details": {
            "id": "40286300",
            "login": "randers",
            ...
            "offline_image_url": "https://static-cdn.jtvnw.net/jtv_user_pictures/0622dc8b-c76c-451d-80c1-bea0d915c829-channel_offline_image-1920x1080.png",
            "view_count": 1079,
